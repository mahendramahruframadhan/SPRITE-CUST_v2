  ...
  return (
    <div ref={rootRef} className="relative">
      <div className="relative">
        <svg className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400 pointer-events-none" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-0.5">
          {text && (
            <button
              ...
              title="Semua brand"
              className={`w-7 h-7 inline-flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition focus-visible:outline-none focus-visible:ring-2 ${t.focusItem}`}
            >
          ...
          <button
            ...
            className={`w-7 h-7 inline-flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 transition focus-visible:outline-none focus-visible:ring-2 ${t.hoverIcon} ${t.focusItem}`}
          >
