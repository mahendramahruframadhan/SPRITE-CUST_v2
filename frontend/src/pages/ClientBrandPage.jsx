      ...
      <div data-kebab-root className="relative shrink-0">
        ...
        {open && (
          <div
            ...
            className="absolute right-0 top-full mt-1 w-44 overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xl z-20 animate-fade-in-fast"
          >
            <button
              role="menuitem"
              onClick={() => startEdit(item)}
              className="w-full flex items-center gap-2.5 px-4 min-h-[44px] text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition focus-visible:outline-none focus-visible:bg-slate-50 dark:focus-visible:bg-slate-800"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-4 min-h-[44px] text-sm font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition focus-visible:outline-none focus-visible:bg-rose-50 dark:focus-visible:bg-rose-500/10"
            >
              <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" aria-hidden="true">
