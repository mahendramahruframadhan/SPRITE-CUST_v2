          ...
          >
            ...
            {modalMode === 'edit' ? (
              <div className="px-5 py-4 space-y-4">
                <div>
                  <label htmlFor="dm-name" className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                    Nama brand <span className="text-rose-500">*</span>
                  </label>
                  <input
                    id="dm-name"
              ...
              <>
                <dl className="px-5 py-4 space-y-3 text-sm">
                  {detailItem.type === 'GRATIS' ? (
                    ...
                    <>
                      <div className="flex items-center justify-between gap-3">
                        <dt className="text-xs font-semibold text-slate-400">Tipe</dt>
                        <dd>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <dt className="text-xs font-semibold text-slate-400">Tercatat sejak</dt>
                        <dd className="font-bold text-slate-800 dark:text-slate-100">{fmtDateID(String(detailItem.createdAt || '').slice(0, 10))}</dd>
                      </div>
                      <p className="text-[11px] text-slate-400">Berlangganan bulanan, tanpa tanggal expired.</p>
                    </>
                  )}
                </dl>
