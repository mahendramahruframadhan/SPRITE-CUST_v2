                  ...
                  <tr key={u.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/70 transition">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="p-2 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-500/10 text-slate-500 dark:text-slate-400 hover:text-brand-600 transition"
                        title="Edit"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-500/10 text-slate-500 dark:text-slate-400 hover:text-rose-500 transition"
                        title="Hapus"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
      ...
      {tab === 'role' && (
        <section className="space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-fade-in-fast">
            ...
            <p className="px-6 py-3 text-[11px] text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={(e) => e.target === e.currentTarget && setModal(null)}>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in-fast">
            <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
              ...
              <button onClick={() => setModal(null)} className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 dark:text-slate-400">
...
function StatCard({ title, value, sub, valueCls = '', subCls = 'text-slate-500 dark:text-slate-400', delay }) {
  return (
