          ...
          {visibleTabs.map((t) => {
            ...
            return (
              <Button
                ...
                className="justify-start text-left shrink-0 lg:shrink px-3 py-2.5"
              >
        ...
        <div key={safeTab} className="flex-1 min-w-0 w-full space-y-5 animate-fade-in-fast">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-3" role="radiogroup" aria-label="Pilih tema">
                  {[
                    ...
                    return (
                      /* eslint-disable-next-line react/forbid-elements -- kartu radio tema (kartu pratinjau kustom) */
                      <button
                        key={o.id}
                        type="button"
                        role="radio"
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3" role="radiogroup" aria-label="Pilih ukuran font">
                  {[
                    ...
                    return (
                      /* eslint-disable-next-line react/forbid-elements -- kartu radio ukuran font (kartu kustom) */
                      <button
                        key={o.id}
                        type="button"
                        role="radio"
          ...
          {safeTab === 'sesi' && (
            <div className="max-w-3xl bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 space-y-4">
              ...
              {/* eslint-disable-next-line react/forbid-elements -- tombol logout rose kustom */}
              <button
                type="button"
                onClick={logout}
