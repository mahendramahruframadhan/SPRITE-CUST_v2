    ...
    <div className="w-full min-w-0 px-3 sm:px-4 md:px-5 py-5 space-y-5">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/70 dark:border-slate-800 shadow-sm p-2 animate-fade-in-fast">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 px-2 pb-1 text-[11px]">
          ...
          <span className="text-slate-500 dark:text-slate-400">— {activeTab.desc}</span>
...
function ListPanel({ title, desc, arr, badge = 'bg-slate-50 text-slate-600 border-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700', onAdd, onDel }) {
  ...
  return (
    <div className="card p-5 animate-fade-in-fast">
      ...
      <p className="text-[11px] text-slate-500 dark:text-slate-400 mb-4">{desc}</p>
      <form
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        ...
        <div className="card p-5">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mb-3">Nomor minggu dan tahun yang dikenali sheet</p>
          <p className="text-[10px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 mb-1.5">Weeknum (1–{cfg.weeknums.length})</p>
          ...
          <p className="text-[10px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 mb-1.5">Year</p>
    ...
    <div className="space-y-5">
      ...
      <div className="card overflow-hidden animate-fade-in-fast">
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-wrap items-center gap-3 justify-between bg-gradient-to-r from-slate-50/80 to-white dark:from-slate-800/60 dark:to-slate-900">
          ...
          <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 rounded-full px-3 py-1">
        ...
        <div key={a.id} className="card p-5 flex items-center gap-4 animate-fade-in-fast">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${a.enabled ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400'}`}>
