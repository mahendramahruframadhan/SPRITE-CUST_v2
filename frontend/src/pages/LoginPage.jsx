...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden p-4">
      ...
      <GradientWave colors={LOGIN_GRADIENT_COLORS} />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        <div className="bg-white/75 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-brand-900/25 ring-1 ring-white/70 border border-white/50 p-8">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Login untuk mengakses dashboard</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 text-sm bg-white/70 border border-white/80 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-400 focus:bg-white/90 transition placeholder:text-slate-400"
                />
              </div>
            </div>
            <div>
            ...
            <div className="flex flex-wrap justify-center gap-1.5">
              {Object.entries(MOCK_USERS).map(([em, u]) => (
                <button
                  ...
                  className="text-[11px] font-semibold text-brand-700 bg-white/70 hover:bg-white border border-white/80 rounded-full px-2.5 py-1 transition"
                >
                  {u.role}
                </button>
              ))}
        ...
        <p className="text-center text-xs text-slate-600 mt-6 drop-shadow-sm">
          © 2025 Pusat Data Bantuan — Sinkron dari Google Sheets
        </p>
        <p className="text-center text-xs text-slate-600 mt-2 drop-shadow-sm">
          Belum punya akun?{' '}
